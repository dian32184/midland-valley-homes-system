@php
    ...
    if ($role === 'documentation' || str_contains($email, 'docs@') || str_contains($email, 'documentation@')) {
        $homeRoute = 'documentationdashboard';
    } elseif ($role === 'manager' || str_contains($email, 'manager@')) {
        $homeRoute = 'managerdashboard';
    } elseif ($role === 'admin' || str_contains($email, 'admin@')) {
        $homeRoute = 'admindashboard';
    } else {
        $homeRoute = 'marketingdashboard';
    }
@endphp
