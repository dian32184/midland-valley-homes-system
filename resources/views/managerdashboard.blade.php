...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .donut { width: 140px; height: 140px; border-radius: 999px; margin: 0 auto 8px; background: conic-gradient(#8b5cf6 0 35%, #22d3ee 35% 57%, #60a5fa 57% 77%, #f472b6 77% 100%); display: grid; place-items: center; }
    ...
    <main class="main">
        <header class="header">
            <div class="h-brand">
                ...
                <div class="h-subtitle">Welcome, {{ auth()->user()->name ?? 'Manager' }}</div>
            </div>
